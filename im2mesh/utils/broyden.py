...
def broyden(g, x_init, T_init, J_inv_init, max_steps=50, cvg_thresh=1e-5, dvg_thresh=1, eps=1e-6):
    ...
    Args:
        ...
        T_init (tensor): initial transformations. shape: [N, 4, 4]
    ...
    for _ in range(max_steps):
        ...
        delta_gx_, T[ids_val] = g(x, mask=ids_val)
        delta_gx[ids_val] = delta_gx_ - gx[ids_val]
        ...
        T_opt[ids_opt] = T.clone().detach()[ids_opt]
    ...
    return {'result': x_opt, 'transforms': T_opt, 'diff': gx_norm_opt, 'valid_ids': gx_norm_opt < cvg_thresh}
